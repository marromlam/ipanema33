...
from ipanema import Parameter, Parameters, optimize, ristra, histogram, plotting
...
axplot.fill_between(hdata1.bins, hdata1.counts,
...
for dataset, n in zip([data1, data2],['1','2']):
  ...
  axplot.fill_between(hdata.bins, hdata.counts,
                      step="mid", color='k',alpha=0.2,
                      label=f"dataset {n}")
  ...
  axpull.fill_between(hdata.bins,
                      histogram.pull_pdf(x,y_bfgs,hdata.bins,hdata.counts,hdata.errl,hdata.errh),
