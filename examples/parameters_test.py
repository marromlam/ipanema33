...
a = ipanema.Parameter("a", 11, stdev=0.1, min=7,
                      max=12.3, latex="a", correl=corr_a)
b = ipanema.Parameter("b", 0.2, stdev=0.3, min=-0.5,
                      max=1.3, latex="b", correl=corr_b)
c = ipanema.Parameter("c", 20.1, stdev=2, min=1,
                      max=20.3, latex="c", correl=corr_c)
